...
data include; *Create variables; 
  ...
  *Variable: APOL1G1;
       If rs73885319 = "0/0" and rs60910145 =   "0/0"         then G1 = 0;   *(there are 1919 participants);
  else If rs73885319 = "0/1" and rs60910145 in ("0/0", "0/1") then G1 = 1;   *(there are 28+1096=1124 participants);
  else If rs73885319 = "1/1" and rs60910145 =   "1/1"         then G1 = 2;   *(there are 170 participants);
  else If rs73885319 = "1/1" and rs60910145 =   "0/1"         then G1 = 1.1; *(11 participants which is the group you called G1a);
