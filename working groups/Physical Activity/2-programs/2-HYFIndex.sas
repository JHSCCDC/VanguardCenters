...
*Calculate the home and yard index (HFY01)*****************************************************************;
	data pa.hfy (keep= subjid HFY01 i12 i13 i14 i15 i16 i17 i18) ;
	set jhsv1.paca ;
	...
	*Recode ; 
		...
		*Home/yard index missing if one of the above scores is missing;
			HFY01 =((i12+i13+i14+i15+i16+i17+i18 )/7) ;
