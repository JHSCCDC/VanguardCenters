...
**************************************************************************************************;
*VO; x 'cd Z:\Jackson Heart Study\VC Packages\VanguardCenters'; * YOU MUST CHANGE THIS TO YOUR DIRECTORY STRUCTURE!:
  ...
  *Primary VC data archetypes;
  ...
  libname pa       "working groups\Physical Activity\1-data";           *Physical Activity working group data;
...
*Create JPAC PA index dataset;
	data pa.derivedPA (label="Derived Physical Activity Domain Measures");
	retain subjid  acl01 hfy01 spt01 wrk01a employed totpa4 totpa3 ;

			merge 	pa.acl 
					pa.hfy 
					pa.work (rename=(pa8=employed))
					pa.sport ;
			by subjid;
